...
// define (it answers 'node' here, which is fine — the store is selected by
// the runtime TREEBED_STORE, and the deployed site sets `blobs`), and
// digest.ts resolves its signing secret from the environment alone.
//
